 ...
 * HISTORY
 * $Log:	collect2.c,v $
 * Revision 2.33  93/02/03  17:03:45  mrt
 * 	Updated to 2.3.3
 * 
 * Revision 2.32.1.1  93/01/20  15:02:48  danner
 * 	Set READ_LD_FILE_NAME to /usr/cs/bin/ld if CMU is defined.
 * 	[92/12/15            danner]
 * 
 */
...
#if defined(CMU)
/* look for ld in the right place */
#define REAL_LD_FILE_NAME "/usr/cs/bin/ld"
#endif
